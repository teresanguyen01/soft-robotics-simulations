...
raise_rhand_mocap = read.csv("/Users/teresanguyen/Documents/Faboratory Stuff/soft-robotics-simulations/data/raise_lhand_mocap_cleaned.csv")
...
path <- file.path("~", "Documents", "Faboratory Stuff", "soft-robotics-simulations", "data", "angle_array_lhand_mocap.csv")
