...
# mocap_data <- read.csv("/Users/teresanguyen/Documents/Faboratory Stuff/soft-robotics-simulations/data/raise_rhand_mocap_cleaned.csv")
...
path <- file.path("~", "Documents", "Faboratory Stuff", "soft-robotics-simulations", "data", "aa_rhand_new.csv")
...
# reverse the sign
# subtract the jump 
# apply a constant to all angles and apply data
