...
# Load data
sensor_data <- read.csv("/Users/teresanguyen/Documents/Faboratory Stuff/soft-robotics-simulations/data/raise_rhand_sensor.csv")
# remove all unnecessary headers
mocap_data <- read.csv("/Users/teresanguyen/Downloads/lhand_060225_uncleaned.csv", skip = 3)
...
path <- file.path("~", "Documents", "Faboratory Stuff", "soft-robotics-simulations", "data", "raise_lhand_mocap_cleaned.csv")
...
data <- read.csv("/Users/teresanguyen/Documents/Faboratory Stuff/soft-robotics-simulations/data/raise_rhand_mocap_cleaned.csv")
head(data)
...
colnames(data)[colnames(data) == "base_X"] <- "base_X.1"
colnames(data)[colnames(data) == "Skeleton.002.Skeleton.002_X"] <- "base_X"
...
path <- file.path("~", "Documents", "Faboratory Stuff", "soft-robotics-simulations", "cleaned_mocap_data", "lhand_060225.csv")
